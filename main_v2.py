...
async def on_message(message):
    ...
    #KOMUTLAR----------------------------------------------------------------------------------
    elif text.startswith('-komutlar'):
        await message.channel.send("-iklim değişikliği nedir \n-iklim değişikliği neden olur \n-iklim değişikliğini nasıl önleyebiliriz")
    #KOMUTLAR----------------------------------------------------------------------------------

    elif text.startswith('-iklim değişikliği nedir') or message.content.startswith('iklim değişikliği?'):
    ...
    elif text.startswith('-iklim değişikliği neden olur'):
        await message.channel.send("En büyük nedenler **fabrika atıkları , egzozlar , yere atılan çöplerdir**") 


    elif text.startswith('-iklim değişikliğini nasıl önleyebiliriz') or message.content.startswith('-iklim değişikliğini nasıl önleyebilirim') or message.content.startswith('-iklim değişikliğini nasıl önlerim'):
    ...
    #FOTOĞRAF YOLLAMA----------------------------------------------------------------------------
    elif text.startswith('-iklim değişikliği fotoğrafları') or message.content.startswith('-iklim değişikliği foto') or message.content.startswith('-iklim foto'):
...
client.run('TOKEN BURAYA / TOKEN İS HERE')
